...
const BreastFeedingMonth18Ar = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`https://gradhub.hwnix.com/api/get_BreastFeeding/18/ar`)
      .then((resp) => {
        setTips({
          ...tips,
          results: resp.data,
                ...
                {tips.results.map((result) => (
                  <tr key={result.id}>
                   ...
                   <td>
                    ...
                    <td>
                      <Link to={"/UpdateBreastFeedingAr/" + result.id}>
...
export default BreastFeedingMonth18Ar;
