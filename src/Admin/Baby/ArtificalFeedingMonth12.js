...
const ArtificalFeedingMonth12 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`https://gradhub.hwnix.com/api/get_BottleFeeding/12/en`)
      .then((resp) => {
        setTips({
          ...tips,
          results: resp.data,
      ...
      <div>
        ...
        {tips.loading ? (
          ...
          <div className="div-container">
            ...
            <Link to={"/ArtificalFeedingMonth12Ar"}>
...
export default ArtificalFeedingMonth12;
