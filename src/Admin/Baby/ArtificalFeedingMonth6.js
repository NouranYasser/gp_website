...
const ArtificalFeedingMonth6 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`https://gradhub.hwnix.com/api/get_BottleFeeding/6/en`)
      .then((resp) => {
        setTips({
          ...tips,
          results: resp.data,
      ...
      <div>
        ...
        {tips.loading ? (
          ...
          <div className="div-container">
            ...
            <Link to={"/ArtificalFeedingMonth6Ar"}>
...
export default ArtificalFeedingMonth6;
